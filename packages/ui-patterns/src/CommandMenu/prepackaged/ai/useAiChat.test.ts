...
This provides more information.`)
    expect(result.sources).toEqual([
      { path: '/guides/auth', url: 'https://selfbase.com/docs/guides/auth' },
      { path: '/guides/database', url: 'https://selfbase.com/docs/guides/database' },
      { path: '/reference/api', url: 'https://selfbase.com/docs/reference/api' },
    ])
  })
...
- /valid/path`
    ...
    expect(result.sources).toEqual([
      { path: '/guides/auth', url: 'https://selfbase.com/docs/guides/auth' },
      { path: '/valid/path', url: 'https://selfbase.com/docs/valid/path' },
    ])
  })
