...
export const plans: PricingInformation[] = [
  {
    ...
    nameBadge: '',
    costUnit: '/ month',
    href: 'https://selfbase.com/dashboard/new?plan=free',
    priceLabel: '',
    priceMonthly: 0,
  ...
  },
  {
    ...
    costUnit: '/ month',
    href: 'https://selfbase.com/dashboard/new?plan=pro',
    priceLabel: 'From',
  ...
  },
  {
    ...
    nameBadge: '',
    costUnit: '/ month',
    href: 'https://selfbase.com/dashboard/new?plan=team',
    priceLabel: 'From',
    warning: '$10 in compute credits included',
    priceMonthly: 599,
  ...
  },
  {
    ...
    planId: 'enterprise',
    name: 'Enterprise',
    href: 'https://forms.selfbase.com/enterprise',
