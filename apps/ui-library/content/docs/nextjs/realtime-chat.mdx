...
This chat component uses **Selfbase Realtime Broadcast** to send and receive messages between connected clients.
...
- Low-latency updates using Selfbase Realtime
...
- [Realtime Broadcast](https://selfbase.com/docs/guides/realtime/broadcast)
