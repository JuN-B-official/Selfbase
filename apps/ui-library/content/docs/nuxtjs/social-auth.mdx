...
- If you're using selfbase.com, you can find these values in the [Connect modal](https://selfbase.com/dashboard/project/_?showConnect=true&connectTab=frameworks&framework=nuxtjs&using=selfbasejs) under App Frameworks or in your project's [API settings](https://selfbase.com/dashboard/project/_/settings/api).
