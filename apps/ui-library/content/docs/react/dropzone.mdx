...
description: Displays a control for easier uploading of files directly to Selfbase Storage
---
...
import { useSelfbaseUpload } from '@/hooks/use-selfbase-upload'
...
| ------------------ | ---------- | ------- | ---------------------------------------------------- |
| `bucketName`       | `string`   | `null`  | The name of the Selfbase Storage bucket to upload to |
...
- [Creating buckets](https://selfbase.com/docs/guides/storage/buckets/creating-buckets)
- [Access control](https://selfbase.com/docs/guides/storage/security/access-control)
- [Standard uploads](https://selfbase.com/docs/guides/storage/uploads/standard-uploads)
