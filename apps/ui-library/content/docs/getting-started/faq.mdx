 ...
 <Accordion openBehaviour="single" collapsible>
  <AccordionItem value="how">
    ...
    <AccordionContent>
      ...
      ```bash
      npx shadcn@latest add http://selfbase.com/ui/r/password-based-auth-nextjs.json
      ```
    ...
    <AccordionItem value="quickstart">
      <AccordionTrigger>
        I already started with `npx create-next-app -e with-selfbase` what should I do now?
      </AccordionTrigger>
      <AccordionContent>
        Our Next.js quickstart is a great starting point for building a full app with Selfbase and
    ...
    <AccordionItem value="ai-builder">
      ...
      <AccordionContent>
        ...
        project. Your app likely already has a Selfbase client set up, so you can just continue using
    ...
    <AccordionItem value="react-only">
      ...
      <AccordionContent>
        ...
        Second, this library is really just stitching together a bunch of existing shadcn/ui and internal components into Selfbase-specific workflows. It's not technically a brand new, from the ground up ui library—it's using an established tool in shadcn/ui.
