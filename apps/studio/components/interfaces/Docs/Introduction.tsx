    ...
    <>
      ...
      <div className="doc-section">
        <article className="code-column text-foreground">
          ...
          <p>
            You can initialize a new Selfbase client using the <code>createClient()</code> method.
            The Selfbase client is your entrypoint to the rest of the Selfbase functionality and is
            the easiest way to interact with everything we offer within the Selfbase ecosystem.
          </p>
        </article>
