import { PostgresMaterializedView, PostgresTable, PostgresView } from '@selfbase/postgres-meta'
import { PostgresForeignTable } from '@selfbase/postgres-meta/dist/lib/types'
