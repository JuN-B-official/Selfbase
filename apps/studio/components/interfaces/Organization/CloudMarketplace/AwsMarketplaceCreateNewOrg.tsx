    ...
    <>
      ...
      <ScaffoldSection>
        <ScaffoldSectionDetail className="text-base">
          <p>
            You’ve subscribed to the Selfbase {onboardingInfo?.plan_name_selected_on_marketplace}{' '}
            Plan via the AWS Marketplace. As a final step, you need to create a Selfbase
