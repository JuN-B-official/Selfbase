    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader padding="small" className="border-b">
          <DialogTitle>Data Privacy and Selfbase AI</DialogTitle>
        </DialogHeader>
        <DialogSection
          padding="small"
        ...
        >
          <p>
            Selfbase AI utilizes third-party AI providers designed with a strong focus on data
            privacy and security.
          </p>

          <p>
            By default, only schema data is shared with third-party AI providers. This is not
            retained by them nor used as training data. With your permission, Selfbase may also
          ...
          <p>
            For organizations with HIPAA compliance enabled in their Selfbase configuration, any
            consented information will only be shared with third-party AI providers with whom
            Selfbase has established a Business Associate Agreement (BAA).
          </p>

          <p>
            For more detailed information about how we collect and use your data, see our{' '}
            <InlineLink href="https://selfbase.com/privacy">Privacy Policy</InlineLink>. You can
