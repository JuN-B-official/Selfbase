      ...
      <ScaffoldSection isFullWidth>
        {!!plan && !canSetupSSOConfig ? (
          <UpgradeToPro
            ...
            secondaryText="SSO as a login option provides additional acccount security for your team by enforcing the use of an identity provider when logging into Selfbase. Upgrade to Team or above to set up SSO for your organization."
