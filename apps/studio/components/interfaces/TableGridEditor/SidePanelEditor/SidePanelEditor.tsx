import type { PostgresColumn, PostgresTable } from '@selfbase/postgres-meta'
...
export const SidePanelEditor = ({
  ...
  const updateTableRealtime = async (table: RetrieveTableResult, enabled: boolean) => {
    ...
    const realtimePublication = publications?.find((pub) => pub.name === 'selfbase_realtime')
