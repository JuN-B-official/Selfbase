...
type HandleIconType = Integration['integration']['name'] | 'Selfbase'
...
const HandleIcon = ({ type, className }: { type: HandleIconType; className?: string }) => {
  switch (type) {
    ...
    case 'Vercel':
      ...
      break
    case 'Selfbase':
      return <img src={`${BASE_PATH}/img/selfbase-logo.svg`} alt="Selfbase" className="w-3.5"></img>
      break
