  ...
  return (
    <APIAuthorizationLayout>
      <div className={`flex flex-col items-center justify-center h-full`}>
        {device_code ? (
          <>
            <h2 className="py-2">Your Selfbase Account is being used to login on Selfbase CLI.</h2>
            <p>Enter this verification code on Selfbase CLI to authorize login.</p>
            ...
            <Admonition
              type="tip"
              title="Browser login flow requires Selfbase CLI version 1.219.0 and above."
              className="mt-16"
            />
          </>
        ) : (
