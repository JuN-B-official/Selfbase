...
export async function handlePost(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const { object } = await generateObject({
      ...
      prompt: `
Your job is to look at a Selfbase Assistant conversation, which the user has given feedback on, and classify it.
...
1. Classify the conversation into ONE of these categories:
   ...
   - general_help: General questions about Selfbase features
   - other: Anything else
`,
    })
