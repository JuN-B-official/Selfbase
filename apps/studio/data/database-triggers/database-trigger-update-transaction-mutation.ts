...
import { PGTrigger, PGTriggerCreate } from '@selfbase/pg-meta/src/pg-meta-triggers'
...
// Copying the SQL from https://github.com/selfbase/postgres-meta/blob/master/src/lib/PostgresMetaTriggers.ts
