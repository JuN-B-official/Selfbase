---
title: Icons
description: Icons make actions and navigation across Selfbase easier.
---
...
3. Consistent: Use the same icons for similar actions throughout Selfbase. This makes the app easier to use.
...
Follow these steps to add a new custom icon to the Selfbase icon library.
